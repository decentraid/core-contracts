...
contract UsdcToken is ERC20 {
    ...
    constructor() ERC20("USDCMocked","USDC") {
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        require(deadline >= block.timestamp, 'MOONGAMES: EXPIRED');
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'MOONGAMES: INVALID_SIGNATURE');
